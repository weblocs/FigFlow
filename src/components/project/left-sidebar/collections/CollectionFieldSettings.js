...
import { editCollectionField, setActiveSettingsCollectionFieldId, setKeyboardNavigationOn } from '../../../../features/project';

export default function CollectionFieldSettings({field}) {
    const isOpen = useSelector((state) => state.project.activeSettingsCollectionFieldId === field.id)
    ...
    return (
        <div>
        <div className='collection-fields-settings_item' onClick={() => dispatch(setActiveSettingsCollectionFieldId(field.id))}>
