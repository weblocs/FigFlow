...
export default function CollectionSettings() {
    ...
    const collection = useSelector((state) => state.project.collections?.find(({id}) => id === activeSettingsCollectionId))
    ...
    function handleSubmit(e) {
        e.preventDefault();
        dispatch(editCollection({id: activeSettingsCollectionId, property: "name", value: nameRef.current.value}));
        dispatch(editCollection({id: activeSettingsCollectionId, property: "slug", value: slugRef.current.value}));
    ...
    return (
        ...
        + ((activeTab === "Collections" && (collectionPanelState === "settings") && activeSettingsCollectionId !== "") ? "active" : "" )
        }>
            <form
