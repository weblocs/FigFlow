            ...
            <div>
              <div className="style-panel-box">
                <div>
                  In Collection:{' '}
                  {
                    collections.find(({ id }) => id === activeCollectionId)
                      ?.name
                  }{' '}
                </div>
                <div>
                  Field:{' '}
                  {
                    collections
                      ...
                      ?.fields.find(
                        ({ id }) => id === activeNodeObject?.cmsFieldId
                      )?.name
                  }
                </div>
              </div>
              ...
              <div className="style-panel-box">
                <div style={{ marginBottom: '6px', lineHeight: '11px' }}>
                  Collections:
                </div>
                    ...
                    {collections
                      ...
                      .map((field) => (
                        <div
                          ...
                          className={
                            'fields-select_item' +
                            (activeNodeObject?.cmsFieldId === field.id
                              ? ' active'
                              : '')
                          }
                        >
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <div>
                  Field:{' '}
                  {
                    collections
                      .find(({ id }) => id === activeCollectionId)
                      .fields.filter(({ type }) => type === 'img')
                      .find(({ id }) => id === activeNodeObject?.cmsFieldId)
                      ?.name
                  }
                </div>
              </div>
